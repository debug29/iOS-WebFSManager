...
typedef enum : NSInteger {
    KeepPriorityRequired = (NSInteger)UILayoutPriorityRequired,
    KeepPriorityHigh = (NSInteger)UILayoutPriorityDefaultHigh,
    KeepPriorityLow = (NSInteger)UILayoutPriorityDefaultLow,
    KeepPriorityFitting = (NSInteger)UILayoutPriorityFittingSizeLevel,
} KeepPriority;
